...
set "files=main.spec theshooterlauncher_deb.deb launcher_win.py launcher_win.spec installer_updater.spec version_win_launcher.txt Version.txt AppVersion.txt GameVersion.txt"
for %%f in (%files%) do (
  if exist "%%~f" (
